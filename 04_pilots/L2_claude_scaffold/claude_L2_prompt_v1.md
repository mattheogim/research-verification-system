...
## Output Schema
Save to `04_pilots/claude_L2_independent.csv` with exactly these columns (order matters):
...
Save only the CSV to `04_pilots/claude_L2_independent.csv`.
